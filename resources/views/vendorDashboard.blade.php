...
@section('main')
    ...
    <div class="lg:p-4 md:p-8 sm:p-6 p-6 text-md sm:ml-64 mt-12 bg-white">
        ...
        <div class="grid mt-4 w-full bg-gray-100 rounded-md lg:grid-cols-6 md:grid-cols-2 grid-cols-1">
            <button class="bg-blue-900 text-white px-4 py-4 rounded-sm lg:border-r-2 md:border-r-2 sm:border-b-2 border-b-2 border-gray-100  hover:bg-blue-800" id="manageProfile">Manage Profile</button>
            <button class="bg-blue-900 text-white px-4 py-4 rounded-sm lg:border-r-2 md:border-r-2 sm:border-b-2 border-b-2 border-gray-100  hover:bg-blue-800" id="manageProducts">Manage Products</button>
            <button class="bg-blue-900 text-white px-4 py-4 rounded-sm lg:border-r-2 md:border-r-2 sm:border-b-2 border-b-2 border-gray-100  hover:bg-blue-800" id="saleOffers">Sales Offers</button>
            <button class="bg-blue-900 text-white px-4 py-4 rounded-sm lg:border-r-2 md:border-r-2 sm:border-b-2 border-b-2 border-gray-100  hover:bg-blue-800" id=quotationManagement>Quotation Management</button>
        </div>
       ...
       <div id="manageProfileForm" class="" >
       ...
       <div id="manageProductsForm" class="hidden">
      ...
      <div id="saleOffersForm" class="hidden">
          <div class="flex  w-full py-6 mt-4 px-4 bg-gray-100 rounded-md">
        ...
        <div id="quotationManagementForm" class="hidden">
            <div class="flex  w-full py-6 mt-4 px-4 bg-gray-100 rounded-md">
