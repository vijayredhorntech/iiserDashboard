...
@section('main')
    ...
    <div class="lg:p-4 md:p-8 sm:p-6 p-6 text-md sm:ml-64 mt-12 bg-white">
        ...
        <div class="grid mt-4 w-full bg-gray-100 rounded-md lg:grid-cols-6 md:grid-cols-2 grid-cols-1"  data-tabs-toggle="#adminForm">
            <button class="form_tab_button  bg-blue-900  px-2 py-2 rounded-sm lg:border-r-2 md:border-r-2 sm:border-b-2 border-b-2 border-blue-100  hover:bg-blue-800 flex flex-col text-sm"  data-tabs-target="#profile"  role="tab" ><span class="m-auto">Register (PI) </span></button>
            <button class="form_tab_button  bg-blue-900  px-2 py-2 rounded-sm lg:border-r-2 md:border-r-2 sm:border-b-2 border-b-2 border-blue-100  hover:bg-blue-800 flex flex-col text-sm"  data-tabs-target="#dashboard"  role="tab" ><span class="m-auto">Register Vendor/Supplier </span></button>
        </div>
