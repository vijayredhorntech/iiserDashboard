...
@section('main')
    ...
    <div class="lg:p-4 md:p-8 sm:p-6 p-6 text-md sm:ml-64 mt-12 bg-white">
        ...
        <div class="grid mt-4 w-full bg-gray-100 rounded-md lg:grid-cols-6 md:grid-cols-2 grid-cols-1"  data-tabs-toggle="#subAdminForm">
            <button class="form_tab_button  bg-blue-900  px-2 py-2 rounded-sm lg:border-r-2 md:border-r-2 sm:border-b-2 border-b-2 border-blue-100  hover:bg-blue-800 flex flex-col text-sm"  data-tabs-target="#registerLabMember"  role="tab" ><span class="m-auto">Register Lab Members </span></button>
            <button class="form_tab_button  bg-blue-900  px-2 py-2 rounded-sm lg:border-r-2 md:border-r-2 sm:border-b-2 border-b-2 border-blue-100  hover:bg-blue-800 flex flex-col text-sm"  data-tabs-target="#quotesManagement"  role="tab" ><span class="m-auto">Quotes Management </span></button>
            <button class="form_tab_button  bg-blue-900  px-2 py-2 rounded-sm lg:border-r-2 md:border-r-2 sm:border-b-2 border-b-2 border-blue-100  hover:bg-blue-800 flex flex-col text-sm"  data-tabs-target="#rolesPermission"  role="tab" ><span class="m-auto">Roles And Permissions </span></button>
            <button class="form_tab_button  bg-blue-900  px-2 py-2 rounded-sm lg:border-r-2 md:border-r-2 sm:border-b-2 border-b-2 border-blue-100  hover:bg-blue-800 flex flex-col text-sm"  data-tabs-target="#rolesPermissionInventory"  role="tab" ><span class="m-auto">Roles And Permissions For Inventory Modules </span></button>
        </div>
        ...
        <div id="subAdminForm">
            <div  id="registerLabMember" role="tabpanel" aria-labelledby="profile-tab">
            ...
            <div  id="quotesManagement" role="tabpanel" aria-labelledby="dashboard-tab">
            ...
            <div  id="rolesPermission" role="tabpanel" aria-labelledby="dashboard-tab">
                <div class="flex  w-full py-6 mt-4 px-4 bg-gray-100 rounded-md">
            ...
            <div  id="rolesPermissionInventory" role="tabpanel" aria-labelledby="dashboard-tab">
                <div class="flex  w-full py-6 mt-4 px-4 bg-gray-100 rounded-md">
